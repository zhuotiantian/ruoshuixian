<template>
  <div class="game-container">
    ...
    <div v-if="gameType === 'pocker'" class="content">
      ...
      <template v-else>
        <div style="font-size:24px">
          <p v-if="currentPage === 'fastPocker' || currentPage === 'marathonPocker'" style="position:absolute;top:5vmin;left:50%;z-index:9999;font-size:16px;transform: translateX(-50%);">本轮记忆时间：{{ returnHourAndMinutes }}</p>
          <div style="margin-bottom:30px">点击选择</div>
          <div v-if="currentPage === 'flashPocker'" style="margin-bottom:7.5px">
      ...
      <div class="btn submit-btn" v-if="page === 'first'" @click="confirm">
        确定
      </div>
    ...
    <div v-else class="content">
      <div>
        <p style="position:absolute;top:5vmin;left:50%;z-index:9999;font-size:16px;transform: translateX(-50%);">本轮记忆时间：{{ returnHourAndMinutes }}</p>
        <div style="margin-bottom:30px">请选择</div>
