    ...
    <div class="container">
        ...
        <div :class="{drop_up:true,up:showDrop,down:!showDrop}">
                ...
                <scroll-view :style="{'height': '384rpx'}" scroll-y="true">
                    <ul class="list">
                        <li v-for="(item,index) in stu_list" :key="index" @click="selectGroup(index)">
                            <span>{{item.name}}</span>
                            <image class="icon" v-if="selectedGroup==index" :src="'/static/images/my/select.png'"></image>
                        </li>
                    </ul>
                </scroll-view>
            </template>
            <template v-else>
                ...
                <scroll-view :style="{'height': '384rpx'}" scroll-y="true">
                    <ul class="list">
                        <li v-for="(item,index) in students" :key="index" @click="selectStudents(index)">
                            <span>{{item.nickname}}</span>
                            <image class="icon" v-if="selectedUser==index" :src="'/static/images/my/select.png'"></image>
                        </li>
                    </ul>
                </scroll-view>
            </template>
...
<script>
    export default {
        ...
        methods: {
            ...
            selectStudents: function(index) {
                this.showDrop = false;
                this.selectedUser = index;
                this.selectStudentsName = this.students[index].nickname;
            },
