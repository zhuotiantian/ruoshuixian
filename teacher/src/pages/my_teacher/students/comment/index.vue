<template>
  <div class="container">
    <textarea placeholder-style="color: #c6c6c6;" name="" id="" cols="30" rows="10" placeholder="输入点评"></textarea>
    <p style="text-align:center"><button class="btn submit-btn" @click="sendMessage">点评</button></p>
